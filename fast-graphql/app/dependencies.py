...
#TODO convert the get_context to return a CustomContext instance extending from BaseContext
async def get_context(
  ...
  print("Nos ha llegado un objeto Request", isinstance(request,WebSocket))
  ...
  return {
    ...
    "user": parse_jwt_data_to_user(request),
