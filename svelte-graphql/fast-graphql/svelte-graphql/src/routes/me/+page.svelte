<script lang="ts">
  ...
  let about = $derived(profile?.about);
      ...
      <div>
        <div class="w-full flex justify-between">
          ...
          <button
            ...
            class="cursor-pointer active:scale-85 active:opacity-80"
            type="button"
            aria-label="Edit"
          >
          {#if !isEditMode }
      ...
      <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="flex-1 block w-full min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300
                ...
                : 'opacity-60 cursor-not-allowed select-none bg-gray-50/50'}"
            />
          </div>
        </div>
        ...
        <div class="sm:col-span-6">
          ...
          <p class="mt-2 text-sm text-gray-500">
            Escribe un par de lineas sobre ti
          </p>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-1">
            <input
              ...
              class="shadow-sm block w-full sm:text-sm border-gray-300 rounded-m
              {isEditMode
                ? 'focus:ring-indigo-500 focus:border-indigo-500'
                : 'opacity-60 cursor-not-allowed select-none bg-gray-50/50'}"
            />
            ...
            <div class="relative flex items-start">
              <div class="flex items-center h-5">
                <input
                  ...
                  class="{isEditMode
                    ? 'focus:ring-indigo-500 focus:border-indigo-500'
                    : 'opacity-60 cursor-not-allowed select-none bg-gray-50/50'} border-gray-300 rounded"
                />
              </div>
