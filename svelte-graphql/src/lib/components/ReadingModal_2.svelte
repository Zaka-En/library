...
{#if isOpen && book && reading}
  ...
  >
    <div
      class="bg-white rounded-xl shadow-2xl max-w-sm w-full p-6 border border-gray-100"
    >
      ...
      <div class="space-y-6">
        ...
        <div class="flex flex-col gap-3">
          <p
            class="text-xs text-gray-400 text-center uppercase tracking-widest font-semibold"
          >
            O también puedes
          </p>
          <button
